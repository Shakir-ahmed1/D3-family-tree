export class FamilyTree {
    ...
    showTab(tab) {
        ...
        setActionTypeLabel(actionType, node, currentNodeId) {
        ...
        infoDisplayer(nodeData, rootNodeId) {
            ...
            const createViewMode = () => {
                ...
                ['name', 'gender', 'title', 'phone', 'address', 'nickName', 'birthDate', 'deathDate', 'ownedById'].forEach((key) => {
                    ...
                    field.innerHTML = `<strong>${key}:</strong> ${nodeData[key] || 'N/A'}`;
            ...
            const createEditMode = () => {
                ...
                saveButton.addEventListener('click', async () => {
                    ...
                    try {
                        const response = await fetch(`http://localhost:3000/api/family-tree/${nodeData.familyTree.id}/nodes/${nodeData.id}/update`, {
                            method: 'PUT',
                ...
                cancelButton.addEventListener('click', createViewMode);
